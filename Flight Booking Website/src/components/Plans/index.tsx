    ...
    <div className="flex w-full pt-5 pb-20 md:px-[200px] px-8 flex-col gap-16 justify-center items-center">
      <div className="flex flex-col w-full items-center">
        ...
        <p className="text-center max-w-[400px] mt-4">
          ...
          nesciunt dolores ad animi reiciendis!
        </p>
      </div>
      <div className="flex w-full items-center justify-center md:flex-row flex-col gap-0">
        {plansList.map((plan) => {
          return (
            <div
              key={plan.title}
            ...
            >
              ...
              <div className="px-4 pt-4 leading-7 text-slate-700 max-w-[400px]">
                ...
                dignissimos placeat doloremque tempore quia, molestiae officia
                nemo in quibusdam laborum.
              </div>
